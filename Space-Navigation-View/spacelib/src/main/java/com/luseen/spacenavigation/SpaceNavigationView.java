...
public class SpaceNavigationView extends RelativeLayout {
    ...
    private void init(AttributeSet attrs) {
        if (attrs != null) {
            ...
            negativeMargin = Math.round(resources.getDimension(R.dimen.negative_margin));
            typedArray.recycle();
        }
    ...
    protected void onSizeChanged(int width, int height, int oldWidth, int oldHeight) {
         ...
         */
        contentWidth = (width - spaceNavigationHeight - negativeMargin) / 2;
...
//            centreButton.getImage().setColorFilter(inActiveCentreButtonIconColor, PorterDuff.Mode.SRC_IN);
        ...
        leftContentParams.rightMargin = 30;
        ...
        rightContentParams.leftMargin = 30;
    ...
    public ImageView getCentreButtonView() {
        return centreButton.getImage();
    }

    public TextView getCentreButtonTextView() {
        return centreButton.getCentreText();
    }
...
//                    centreButton.getImage().setColorFilter(activeCentreButtonIconColor, PorterDuff.Mode.SRC_IN);
//
//                    if (activeCentreButtonBackgroundColor != NOT_DEFINED) {
//                        centreButton.getImage().setBackgroundTintList(ColorStateList.valueOf(activeCentreButtonBackgroundColor));
//                    }
//                }
//            }
...
//
//                    if (activeCentreButtonBackgroundColor != NOT_DEFINED) {
//                        centreButton.getImage().setBackgroundTintList(ColorStateList.valueOf(centreButtonColor));
//                    }
//                }
//            }
        }
